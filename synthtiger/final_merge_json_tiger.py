...
def main():
    ...
    NEW_BOX_DATA_PATH = "/mnt/bn/ocr-doc-nas/zhuhanshen/project/TextEvaluator/hanzi_writer/synthtiger/Syn_JTEQAv2_box_anno.json"  # 需替换为实际box数据路径

    NEW_IMG_DATA_PATH = "/mnt/bn/ocr-doc-nas/zhuhanshen/project/TextEvaluator/hanzi_writer/synthtiger/Syn_JTEQAv2_img_anno.json"  # 需替换为实际img数据路径
  
    

    # 输出路径
    OUTPUT_DIR = "/mnt/bn/ocr-doc-nas/zhuhanshen/project/TextEvaluator/hanzi_writer/synthtiger"
    ...
    # train_box_sem,eval_box_sem = split_eval_and_train(new_box_data_sem,eval_size=50)
    ...
    train_box_anno = rename_ids(train_box_anno, "esyn_annotrain_box")
    eval_box_anno = rename_ids(eval_box_anno, "esyn_annotrain_box")
    ...
    #     train_path
    # )
    save_json_data(train_img_anno, os.path.join(OUTPUT_DIR, "tJTEQAv2_img_anno.json"))
    save_json_data(train_box_anno, os.path.join(OUTPUT_DIR, "tJTEQAv2_box_anno.json"))
    # 保存验证集
    save_json_data(eval_img_anno, os.path.join(OUTPUT_DIR, "eJTEQAv2_img_anno.json"))
    save_json_data(eval_box_anno, os.path.join(OUTPUT_DIR, "eJTEQAv2_box_anno.json"))
